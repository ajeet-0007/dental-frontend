              ...
              >
                {filteredDepartments.map((department: any, index: number) => (
                  ...
                  >
                    ...
                    >
                      <div className="aspect-[4/3] bg-gray-50 rounded-xl overflow-hidden border border-gray-100 group-hover:border-gray-200 group-hover:shadow-sm transition-all duration-300">
                        {department.image ? (
                          <img
