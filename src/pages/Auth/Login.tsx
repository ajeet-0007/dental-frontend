          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-6 lg:p-8">
            ...
            <div className="mt-6">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:border-gray-400 shadow-sm transition-all duration-200 active:scale-[0.98]"
                >
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="px-3 bg-white text-xs text-gray-500">New to Dentzoo?</span>
                </div>
              </div>
