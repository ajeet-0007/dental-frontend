...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* <ChatWidget /> */}
      <a
        href="https://wa.me/918979353136"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-20 md:bottom-6 right-4 md:right-6 w-12 md:w-14 h-12 md:h-14 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-colors flex items-center justify-center z-50"
